...
export class OrdersService {
  ...
  private validateOrder(createOrderDto: CreateOrderDto): void {
    // Check required fields - these should be handled by ValidationPipe if using the DTO class,
    // but we'll keep them as a second layer of defense or for non-web callers.
