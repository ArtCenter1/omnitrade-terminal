    ...
    <ProtectedLayout>
      <div className="container mx-auto p-6">
        ...
        <div className="bg-theme-card rounded-lg p-6 shadow-theme-md theme-transition">
          <h2 className="text-xl font-medium mb-4 text-theme-primary">
            Admin Dashboard
          </h2>
          <p className="text-theme-secondary mb-6">
            Welcome to the administration center. Here you can manage users,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-800 rounded-lg p-4">
              <h3 className="font-medium mb-4 border-b border-gray-700 pb-2">
                Recent Activity
              </h3>
              ...
              <button className="text-sm text-blue-400 mt-3 hover:text-blue-300">
                View all activity →
              </button>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center justify-between">
                  ...
                  <span className="text-xs bg-blue-500 text-blue-900 px-2 py-1 rounded">
                    Medium
                  </span>
                </li>
                <li className="flex items-center justify-between">
                  ...
                  <span className="text-xs bg-green-500 text-green-900 px-2 py-1 rounded">
                    Low
                  </span>
                </li>
              </ul>
