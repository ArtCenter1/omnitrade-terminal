...
export default function ResetPasswordPage() {
  ...
  const handleResetPassword = (e: React.FormEvent) => {
    ...
    setIsSuccess(false);
    toast.info(
      "Please use the password reset link sent to your email. If you did not receive it, request a new password reset."
    );
      ...
      <Card className="w-full max-w-md bg-gray-900 border-gray-800 text-white">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center text-gray-400">
            Please use the password reset link sent to your email to reset your
            password.
          </CardDescription>
        </CardHeader>
        <CardContent>
