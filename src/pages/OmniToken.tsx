...
export function OmniTokenPage() { // Renamed function
  return (
      ...
      <main className="flex-grow">
        ...
        <section className="container mx-auto px-4 py-20 md:py-32 text-center">
          <div className="max-w-4xl mx-auto">
             {/* Optional: Token Icon */}
             {/* <img src="/omni-token-icon.svg" alt="Omni Token Icon" className="h-16 w-16 mx-auto mb-4" /> */} {/* Updated alt text */}
            ...
            <p className="text-lg text-gray-400 mb-10 max-w-2xl mx-auto">
              OMNI is the native utility and governance token, unlocking premium features, rewards, and participation in the platform's future.
            </p>
        ...
        <section className="py-16 bg-gray-900/50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">Omni Token Utility</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700 text-center">
                ...
                <p className="text-gray-400">Hold or stake OMNI tokens to enjoy significant discounts on platform fees.</p>
              </div>
              {/* Utility 2 */}
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700 text-center">
              ...
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700 text-center">
                ...
                <p className="text-gray-400">Earn passive income by staking your OMNI tokens and contributing to the network.</p>
              </div>
               ...
               <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700 text-center md:col-span-2 lg:col-span-1 lg:col-start-2">
                ...
                <p className="text-gray-400">Participate in platform decisions and shape the future of OmniTrade.</p>
              </div>
            </div>
          </div>
        </section>
