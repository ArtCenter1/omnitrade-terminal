      ...
      <main className="flex-grow">
        ...
        <section className="container mx-auto px-4 py-20 md:py-32 text-center">
          <div className="max-w-4xl mx-auto">
            {/* Optional: Token Icon */}
            {/* <img src="/omni-token-icon.svg" alt="Omni Token Icon" className="h-16 w-16 mx-auto mb-4" /> */}{" "}
            {/* Updated alt text */}
            ...
            <h2 className="text-2xl md:text-3xl text-gray-300 mb-6">
              Powering the OmniTrade Ecosystem
            </h2>
            <p className="text-lg text-gray-400 mb-10 max-w-2xl mx-auto">
              OMNI is the native utility and governance token, unlocking premium
              features, rewards, and participation in the platform's future.
            </p>
            <div className="flex justify-center space-x-4">
              <Button
                size="lg"
                className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-8 py-3 rounded-full text-lg group"
              >
                Get Omni Token <ShoppingCart className="ml-2 h-5 w-5" />
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="border-gray-500 hover:border-white hover:bg-gray-800 text-white font-semibold px-8 py-3 rounded-full text-lg group"
              >
                Read Whitepaper{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700 text-center">
                ...
                <p className="text-gray-400">
                  Hold or stake OMNI tokens to enjoy significant discounts on
                  platform fees.
                </p>
              </div>
              {/* Utility 2 */}
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700 text-center">
                ...
                <p className="text-gray-400">
                  Unlock advanced analytics, exclusive bot strategies, and early
                  access to new tools.
                </p>
              </div>
              {/* Utility 3 */}
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700 text-center">
                ...
                <p className="text-gray-400">
                  Earn passive income by staking your OMNI tokens and
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="bg-gray-800/60 p-8 rounded-lg shadow-lg border border-gray-700 max-w-3xl mx-auto">
              <p className="text-gray-400">
                Detailed token distribution, supply schedule, and economic model
