            ...
            <div className="flex flex-col items-center justify-center space-y-10 text-center">
              <div className="space-y-4 max-w-3xl">
                ...
                <p className="mx-auto max-w-[700px] text-theme-secondary md:text-xl">
                  Advanced trading platform with powerful bots, real-time market
                  data, and a thriving community.
                </p>
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-lg text-gray-400">
                Platform features designed for traders at all levels
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col p-6 bg-gray-800 rounded-lg shadow-lg">
                ...
                <p className="text-gray-400 flex-grow">
                  Automate your trading strategies and execute trades 24/7 with
                  customizable bots.
                </p>
                <Button
                  variant="link"
                  onClick={() => navigate("/trading-bots")}
                  className="mt-4 px-0 justify-start"
                >
                  Learn more
                </Button>
              </div>
              <div className="flex flex-col p-6 bg-gray-800 rounded-lg shadow-lg">
                ...
                <p className="text-gray-400 flex-grow">
                  Connect to all major exchanges and manage your portfolio from
                  a single dashboard.
                </p>
              ...
              <div className="flex flex-col p-6 bg-gray-800 rounded-lg shadow-lg">
                ...
                <p className="text-gray-400 flex-grow">
                  Join a community of traders, compete on leaderboards, and
                  learn from the best.
                </p>
                <Button
                  variant="link"
        ...
        <section className="py-20 bg-gray-950">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-400">
                See who's leading our trading community
              </p>
            </div>
            <LeaderboardPreview />
