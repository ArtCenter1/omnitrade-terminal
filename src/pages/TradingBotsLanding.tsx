        ...
        <section className="container mx-auto px-4 py-20 md:py-32 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-400 mb-10 max-w-2xl mx-auto">
              Access a marketplace of pre-built strategies or create your own
              custom bots. Trade 24/7 across multiple exchanges without emotion.
            </p>
            <div className="flex justify-center space-x-4">
              <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full text-lg group"
              >
        ...
        <section className="py-16 bg-gray-900/50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              Why Use OmniTrade Trading Bots?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700">
                ...
                <p className="text-gray-400">
                  Never miss an opportunity. Bots trade around the clock based
                  on your strategy.
                </p>
              </div>
              {/* Feature 2 */}
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  Diverse Strategy Marketplace
                </h3>
                <p className="text-gray-400">
                  Choose from a wide range of proven strategies developed by
                  experts.
                </p>
              </div>
              {/* Feature 3 */}
              <div className="bg-gray-800/60 p-6 rounded-lg shadow-lg border border-gray-700">
                ...
                <p className="text-gray-400">
                  Fine-tune existing bots or build your own from scratch with
                  our intuitive tools.
                </p>
              </div>
              {/* Feature 4 */}
