            ...
            <div className="bg-gray-900 rounded-lg p-6 mb-8">
              <div className="flex items-center mb-4">
                ...
                <div className="flex items-center ml-2 text-sm text-gray-400">
                  <span>
                    Hold OMNI in your account to earn rewards and get live
                    upgrades!
                  </span>
                </div>
              </div>
              ...
              <div className="flex justify-end">
                <Button
                  variant="outline"
                  className="flex items-center space-x-1 border-green-500 text-green-500 hover:bg-green-500 hover:bg-opacity-10"
                >
                ...
                <table className="w-full mb-6">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="py-3 px-4 text-sm text-crypto-green">
                        3%
                      </td>
                      <td className="py-3 px-4 text-sm text-crypto-green">
                        0 OMNI
            ...
            <div className="bg-gray-900 rounded-lg p-6 mb-8">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                  ...
                  <div className="bg-gray-800 rounded-lg p-6">
                    ...
                    <p className="text-gray-400 text-sm">
                      from fees generated via Uniswap.
                    </p>
                  </div>
                </div>
              ...
              <div>
                  ...
                  <div className="bg-gray-800 rounded-lg overflow-hidden">
                    ...
                    <div className="p-3">
                      ...
                      <div className="text-sm text-white">
                        Go to Uniswap Pool & Select V3 Liquidity
                      </div>
                    </div>
                  </div>
                ...
                <div className="text-xs text-gray-400 mb-6">
                  NOTE: If liquidity you add is withdrawn prior to the end of
                  program, you will be disqualified from rewards.
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gray-800 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-white font-medium">
                      Share your referral code with your community
                    </h3>
                  </div>
                  <p className="text-gray-400 text-sm">
                    Simple to share via social media.
                  </p>
                </div>
                ...
                <div className="bg-gray-800 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-white font-medium">
                      Earn rewards as they signup
                    </h3>
                  </div>
                  <p className="text-gray-400 text-sm">
                    You get $20 when they create an external wallet.
                  </p>
                </div>
                ...
                <div className="bg-gray-800 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-white font-medium">
                      The more your referrals you do, the more you earn
                    </h3>
                  </div>
                  <p className="text-gray-400 text-sm">
                    Increase your pay for each additional referral.
                  </p>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center mb-4">
                      <div className="bg-gray-800 p-2 rounded text-white text-sm flex-grow mr-2 truncate">
                        https://omnitrade.com/?r=Ga64wyTcH2ZwPoAwmNgEzu{" "}
                        {/* Assuming domain change */}
                      </div>
                      <Button
                        variant="outline"
                        className="border-gray-700 hover:bg-gray-800 px-2 py-1 h-auto"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                    ...
                    <div className="flex space-x-2 mb-4">
                      <Button
                        variant="outline"
                        size="sm"
                        className="border-gray-700 hover:bg-gray-800 px-2 py-1 h-8"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
