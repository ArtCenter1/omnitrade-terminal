...
const UserProfilePage: React.FC = () => {
  ...
  const activityLog = [
    {
      activity: "Logged in",
      dateTime: "2025-04-04 10:00 AM",
      ip: "192.168.1.1",
      location: "New York, USA",
    },
    {
      activity: "Updated profile",
      dateTime: "2025-04-03 03:15 PM",
      ip: "10.0.0.5",
      location: "London, UK",
    },
    {
      activity: "Changed password",
      dateTime: "2025-04-01 09:30 AM",
      ip: "172.16.0.10",
    ...
    <div className="flex min-h-screen bg-gray-900 text-gray-200">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        {activeSection === "User Profile" && (
          <>
            ...
            <section className="mb-10 bg-gray-800 p-6 rounded-lg border border-gray-700">
              <h2 className="text-xl font-semibold mb-4 text-gray-300 border-b border-gray-600 pb-2">
                General Information
              </h2>
        ...
        {activeSection === "Preferences" && (
          <section className="mb-10 bg-gray-800 p-6 rounded-lg border border-gray-700">
            <h2 className="text-xl font-semibold mb-6 text-gray-300 border-b border-gray-600 pb-3">
              Preferences
            </h2>
          ...
          <section className="mb-10 bg-gray-800 p-6 rounded-lg border border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="border border-gray-600 rounded-lg p-4 flex flex-col justify-between bg-gray-750 hover:border-blue-500 transition-colors duration-200">
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      Unlock powerful analytics, priority support, and advanced
                      bot strategies.
                    </p>
                  </div>
                ...
                <div className="border-2 border-green-500 rounded-lg p-4 flex flex-col justify-between bg-gray-750 relative">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      Enhanced features including real-time data, multiple bots,
                ...
                <div className="border border-gray-600 rounded-lg p-4 flex flex-col justify-between bg-gray-750 hover:border-yellow-500 transition-colors duration-200">
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      Basic features for getting started with crypto trading and
                      bot usage.
                    </p>
                  </div>
                  <div className="mt-auto">
            ...
            <div className="mt-8 pt-5 border-t border-gray-600 text-center">
              <p className="text-sm text-gray-400 mb-3">
                Need more information about what each plan offers?
              </p>
        ...
        {activeSection === "Change Password" && (
          <section className="mb-10 bg-gray-800 p-6 rounded-lg border border-gray-700">
            ...
            <div className="max-w-md">
              {" "}
              {/* Optional: Constrain width for better form layout */}
              <h3 className="text-lg font-medium text-gray-400 mb-4">
              ...
              {/* Save Button */}
              <div className="mt-6 pt-5 border-t border-gray-600 flex justify-start">
                {" "}
                {/* Changed justify-end to justify-start based on common form layouts */}
                <button
                  type="button" // Change to submit later
                ...
                >
                  SAVE CHANGES{" "}
                  {/* Changed from UPDATE PASSWORD to match image description */}
                </button>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10 bg-gray-800 p-6 rounded-lg border border-gray-700">
            ...
            <div className="bg-gray-750 p-5 rounded-md border border-gray-600">
              ...
              <p className="text-sm text-gray-400 mb-4">
                ...
                Authentication (2FA). This adds an extra layer of protection by
                requiring a code from your authenticator app or SMS when logging
                in.
              </p>
          ...
          <section className="mb-10 bg-gray-800 p-6 rounded-lg border border-gray-700">
            ...
            <div className="mb-6 pb-4 border-b border-gray-600">
              ...
              <p className="text-sm text-gray-400">
                Manage your connected exchange API keys. Add new keys or remove
                existing ones.
              </p>
            </div>
            {/* Add Exchange Modal */}
        ...
        <section className="bg-red-900 bg-opacity-20 border border-red-500 p-6 rounded-lg mt-10">
          ...
          <p className="text-sm text-red-300 mb-4">
            ...
            All your data, including profile information, trading history, and
