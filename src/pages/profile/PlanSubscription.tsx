        ...
        <div>
          ...
          <div className="bg-gray-800 rounded-lg p-4 mb-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-gray-300 text-xs uppercase font-semibold mb-1">
                  ADVANCED
                </div>
                <div className="text-sm text-gray-300">
                  For professional traders with limitless trading + automation
                  needs.
                </div>
              </div>
              <div>
                <Select defaultValue="omni">
                  {" "}
                  ...
                  <SelectContent className="bg-gray-800 border-gray-700 text-white">
                    <SelectItem value="omni">
                      $50/month - Pay with OMNI (50% off)
                    </SelectItem>{" "}
                    {/* Updated value and text */}
                    <SelectItem value="usd">
                      $100/month - Pay with USD
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          <div className="border border-green-600 rounded-lg p-4 relative">
            <span className="absolute top-0 right-4 text-green-500">
              Current Plan
            </span>
            <div className="flex items-start mt-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-300 mb-4">
                  For advanced traders with higher trading volume + automation
                  needs.
                </p>
          ...
          <div className="bg-gray-800 rounded-lg p-4 mt-6">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-300 mb-4">
                  For beginners with basic monitoring, and limited trading +
                  automation needs.
                </p>
                <Button
                  variant="outline"
