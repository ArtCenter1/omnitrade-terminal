 ...
 * Demo Workspace
 * 
 * A demo workspace with multiple instances of the demo component to showcase
 ...
 */
export const demoWorkspace: WorkspaceTemplate = {
  id: 'demo-workspace',
  name: 'Demo Workspace',
  description: 'A demo workspace with multiple instances of the demo component to showcase the VS Code-like tab behavior',
  category: 'demo',
  tags: ['demo', 'tabs'],
  root: {
    id: 'root',
