 ...
 */
export class TerminalTabsComponent extends BaseTerminalComponent<TerminalTabsComponentProps, TerminalTabsComponentState> implements IComponent {
    ...
    super(
      {
        id: 'terminal-tabs',
        name: 'Terminal Tabs',
        description: 'Displays orders, positions, and other trading information',
        version: '1.0.0',
        category: 'trading',
