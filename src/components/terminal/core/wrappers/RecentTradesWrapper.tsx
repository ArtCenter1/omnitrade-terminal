 ...
 */
const SimpleRecentTrades: React.FC<{selectedPair?: TradingPair}> = ({ selectedPair }) => {
  const symbol = selectedPair?.symbol || 'BTC/USDT';
  
  // Generate some mock trades
  const mockTrades = [
    { id: 1, price: '64,235.50', amount: '0.0125', side: 'buy', time: '12:45:32' },
    { id: 2, price: '64,230.25', amount: '0.0532', side: 'sell', time: '12:45:28' },
    { id: 3, price: '64,228.75', amount: '0.0210', side: 'sell', time: '12:45:15' },
    { id: 4, price: '64,240.00', amount: '0.0075', side: 'buy', time: '12:45:10' },
    { id: 5, price: '64,238.50', amount: '0.0350', side: 'buy', time: '12:45:05' },
    { id: 6, price: '64,225.00', amount: '0.0420', side: 'sell', time: '12:44:58' },
    { id: 7, price: '64,222.75', amount: '0.0180', side: 'sell', time: '12:44:45' },
    { id: 8, price: '64,245.25', amount: '0.0095', side: 'buy', time: '12:44:32' },
  ];
      ...
      <div className="text-xs">
        ...
        {mockTrades.map((trade) => (
          ...
          >
            ...
            <div>
              {(parseFloat(trade.price.replace(',', '')) * parseFloat(trade.amount)).toFixed(2)}
            </div>
 ...
 */
export class RecentTradesComponent extends BaseTerminalComponent<RecentTradesComponentProps, RecentTradesComponentState> implements IComponent {
