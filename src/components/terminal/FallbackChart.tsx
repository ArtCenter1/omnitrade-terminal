...
export function FallbackChart({ selectedPair, timeframe }: FallbackChartProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ backgroundColor: '#131722' }}>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 30 }}>
            ...
            <Tooltip 
              ...
              contentStyle={{ backgroundColor: '#1e222d', borderColor: '#555', color: '#fff' }}
            />
            <Line 
              type="monotone" 
              dataKey="price" 
