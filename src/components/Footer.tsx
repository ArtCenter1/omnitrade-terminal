  ...
  return (
    <div className="border-t border-gray-800 mt-8 px-6 py-8">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-400 mb-2">
                (New Version Launches Soon)
              </div>
              <div className="flex space-x-2">
                <Button
                  variant="outline"
                  className="border-gray-600 bg-black hover:bg-gray-900 flex items-center space-x-1 p-1 h-auto"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
      ...
      <div className="mt-12 text-gray-500 text-xs leading-relaxed">
        <p className="mb-4">
          Disclaimer: Information contained herein should not be construed as an
          investment advice, or investment recommendation, or an order of, or
          solicitation for, any transactions in financial instruments; it makes
          no warranty or representation, whether express or implied, as to the
          accuracy or completeness of the data found herein, or as to the
          fitness thereof for a particular purpose. Use of images and symbols is
          made for illustrative purposes only and does not constitute a
          recommendation to buy, sell or hold a particular financial instrument.
          Use of brand logos does not necessarily imply a contractual
          relationship between us and the entities owning the logos, nor does it
          represent an endorsement of any such entity by OmniTrade, or vice
          versa. Market information is made available to you only as a service,
          and we do not endorse or approve it.
        </p>
        <p>
          Backtested or simulated performance results have inherent limitations
          and should not be interpreted as a recommendation to buy or sell any
          assets nor a guarantee of future returns. Actual results will vary
          from the analysis and OmniTrade makes no representation or warranty
          regarding future performance.
        </p>

        <div className="text-center mt-8">
          Copyright © OmniTrade Global, Ltd (BVI){" "}
          {/* Assuming company name change too */}
        </div>
      </div>
    </div>
  );
