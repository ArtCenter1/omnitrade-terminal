...
function TradingViewWidget({ selectedPair, interval = 'D' }: TradingViewWidgetProps) {
  ...
  }, [selectedPair, theme, interval]); // Re-run when selectedPair, theme, or interval changes
